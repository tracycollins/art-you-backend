...
ImageTools.prototype.analyzeImage = (p) =>
  new Promise(function (resolve, reject) {
    ...
    const imageFileBase = path.parse(imageFile).base;
    const googleCloudStorageImageUri = `gs://art-you/artwork/artists/${artist}/images/${imageFile}`;
    const googleCloudStorageResultsUri = `gs://art-you/artwork/artists/${artist}/image_analysis/google/${imageFileBase}.json`;
    ...
    console.log(
      chalkLog(
        `${MODULE_ID_PREFIX} | ANALYZE IMAGE | TECH: ${imageTechnology} | ${googleCloudStorageImageUri}`
      )
    );
